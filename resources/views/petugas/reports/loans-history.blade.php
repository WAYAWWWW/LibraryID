...
<head>
    ...
    <title>Riwayat Peminjaman - Petugas LibraryID</title>
    ...
    <link rel="stylesheet" href="{{ asset('css/petugas-reports-loans-history.css') }}">
    ...
    <div class="dashboard-container">
        ...
        <div class="dashboard-content">
            ...
            <div class="filter-section">
                ...
                <form method="GET" action="{{ route('petugas.reports.loans.history') }}">
                    <div class="filter-row">
                        ...
                        <div style="display: flex; gap: 0.5rem;">
                            ...
                            <a href="{{ route('petugas.reports.loans.history') }}" class="reset-button">Reset</a>
                            <a href="{{ route('petugas.reports.loans.excel', request()->query()) }}" class="filter-button" style="background:#28a745;">Export Excel</a>
                        </div>
                    </div>
                </form>
            </div>
                                ...
                                <td>
                                    @switch($loan->status)
                                        ...
                                        @case('active')
                                            ...
                                            @break
                                        @case('returning')
                                            <span class="status-badge status-returning">Pengembalian</span>
                                            @break
                                        @case('returned')
